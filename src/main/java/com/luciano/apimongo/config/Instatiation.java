...
import com.luciano.apimongo.dto.AuthorDTO;
import com.luciano.apimongo.dto.CommentDTO;
...
public class Instatiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("15/05/2018"), "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
